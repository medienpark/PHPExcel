...
class PHPExcel_CachedObjectStorageFactory
{
     ...
     * @var string[]
     */
    private static $storageMethods = [self::cache_in_memory, self::cache_in_memory_gzip, self::cache_in_memory_serialized, self::cache_igbinary, self::cache_to_phpTemp, self::cache_to_discISAM, self::cache_to_apc, self::cache_to_memcache, self::cache_to_wincache, self::cache_to_sqlite, self::cache_to_sqlite3];
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = [])
    {
        ...
        if (!call_user_func(
            [$cacheStorageClass, 'cacheMethodIsAvailable']
        )
        ) {
            return false;
        }
