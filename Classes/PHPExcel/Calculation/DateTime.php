...
class PHPExcel_Calculation_DateTime
{
     ...
     *                          date system: 1900 or 1904. If year is between 0 (zero) and
     *                          1899 (inclusive), Excel adds that value to 1900 to calculate
     *                          the year. For example, DATE(108,1,2) returns January 2, 2008
     *                          (1900+108). If year is between 1900 and 9999 (inclusive),
     *                          Excel uses that value as the year. For example, DATE(2008,1,2)
     *                          returns January 2, 2008. If year is less than 0 or is 10000 or
     *                          greater, Excel returns the #NUM! error value.
     * @param    integer $month A positive or negative integer representing the month of the year
     *                          from 1 to 12 (January to December). If month is greater than 12,
     *                          month adds that number of months to the first month in the year
     *                          specified. For example, DATE(2008,14,2) returns the serial number
     *                          representing February 2, 2009. If month is less than 1, month
     *                          subtracts the magnitude of that number of months, plus 1, from
     *                          the first month in the year specified. For example,
     *                          DATE(2008,-3,2) returns the serial number representing September
     *                          2, 2007.
     * @param    integer $day   A positive or negative integer representing the day of the month
     *                          from 1 to 31. If day is greater than the number of days in the
     *                          month specified, day adds that number of days to the first day
     *                          in the month. For example, DATE(2008,1,35) returns the serial
     *                          number representing February 4, 2008. If day is less than 1, day
     *                          subtracts the magnitude that number of days, plus one, from the
     *                          first day of the month specified. For example, DATE(2008,1,-15)
     ...
     *                           Any value greater than 23 will be divided by 24 and
     *                           the remainder will be treated as the hour value. For
     *                           example, TIME(27,0,0) = TIME(3,0,0) = .125 or 3:00 AM.
     * @param    integer $minute A number from 0 to 32767 representing the minute.
     *                           Any value greater than 59 will be converted to
     ...
     *                           TIME(0,0,2000) = TIME(0,33,22) = .023148 or
     *                           12:33:20 AM
     * @return   mixed    Excel date/time serial value, PHP date/time serial value or PHP date/time object,
     *                        depending on the value of the ReturnDateType flag
     */
     ...
     *                             For example, "1/30/2008" or "30-Jan-2008" are text strings
     *                             within quotation marks that represent dates. Using the
     *                             default date system in Excel for Windows, date_text must
     *                             represent a date from January 1, 1900, to December 31, 9999.
     *                             Using the default date system in Excel for the Macintosh,
     *                             date_text must represent a date from January 1, 1904, to
     *                             December 31, 9999. DATEVALUE returns the #VALUE! error value
     *                             if date_text is out of this range.
     * @return   mixed    Excel date/time serial value, PHP date/time serial value or PHP date/time object,
     *                        depending on the value of the ReturnDateType flag
     */
     ...
     *                             Excel time formats; for example, "6:45 PM" and "18:45" text
     *                             strings within quotation marks that represent time. Date
     *                             information in time_text is ignored.
     * @return   mixed    Excel date/time serial value, PHP date/time serial value or PHP date/time object,
     *                        depending on the value of the ReturnDateType flag
     */
     ...
     *                               strings that will be excluded from the working calendar,
     ...
     *                                 A positive value for months yields a future
