...
class PHPExcel_Worksheet_AutoFilter implements \Stringable
{
     ...
     * @return boolean
     */
    private static function filterTestInSimpleDataSet(mixed $cellValue, $dataSet)
    {
     ...
     * @return boolean
     */
    private static function filterTestInDateGroupSet(mixed $cellValue, $dataSet)
    {
     ...
     * @return boolean
     */
    private static function filterTestInCustomDataSet(mixed $cellValue, $ruleSet)
    {
     ...
     * @return boolean
     */
    private static function filterTestInPeriodDateSet(mixed $cellValue, $monthSet)
    {
        //    Blank cells are always ignored, so return a FALSE
        if (($cellValue == '') || ($cellValue === null)) {
            return false;
            ...
            case PHPExcel_Worksheet_AutoFilter_Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER:
                ...
                foreach ($rules as $rule) {
                    ...
                    if (($dynamicRuleType == PHPExcel_Worksheet_AutoFilter_Column_Rule::AUTOFILTER_RULETYPE_DYNAMIC_ABOVEAVERAGE) 
                        ...
                        $columnFilterTests[$columnID] = ['method' => 'filterTestInCustomDataSet', 'arguments' => ['filterRules' => $ruleValues, 'join' => PHPExcel_Worksheet_AutoFilter_Column::AUTOFILTER_COLUMN_JOIN_OR]];
                    } else {
                        //    Date based
